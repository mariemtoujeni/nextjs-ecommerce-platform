...
export const sendReturnReceivedEmailUseCase = async (retour: ReturnPresenter): Promise<BodyResponse> => {
    ...
    const emailResponse = await emailService.sendReturnReceivedEmail(retour);
