...
import { Department, ModelAttributValue, ModelWithProduct, Shop, ShopInput, shopInputSchema, 
    ShopLine, ShopLineInput, shopLineInputSchema, ShopPresenterInput, ShopStatus, UserRoles } from "../../../models";
...
const createShopLine = async (shopLines: ShopLineInput[]) : Promise<ShopLine[]> => {
...
export const createShopWhithShopLinesUseCase = async (shop: ShopPresenterInput) : Promise<ReturnOne<ShopPresenterWithModels>> => {
